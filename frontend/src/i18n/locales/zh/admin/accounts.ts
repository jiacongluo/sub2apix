export default {
    accounts: {
      ...
      dataImportWarning: '导入将创建新账号与代理，已存在账号会自动跳过，分组需手工绑定。',
      dataImportFile: '数据文件',
      ...
      deleteErrorStatus: {
        title: '删除所有错误账号',
        message: '此操作将一次性删除所有账号中状态为错误的账号，不受当前页和当前筛选影响。此操作无法撤销，是否继续？',
        confirm: '删除错误账号',
        countLoading: '正在统计当前错误状态账号数量...',
        countInfo: '当前共有 {count} 个错误状态账号。',
        countUnavailable: '暂时无法获取当前错误状态账号数量。',
        success: '已删除 {count} 个错误账号',
        partialSuccess: '部分删除成功：成功 {success} 个，失败 {failed} 个',
        failed: '删除错误账号失败'
      },
      recoverState: '恢复状态',
