export default {
    accounts: {
      ...
      dataImportWarning: 'Import will create new accounts/proxies; existing accounts are skipped automatically. Groups must be bound manually.',
      ...
      bulkActions: {
        ...
        refreshToken: 'Refresh Token',
        deleteErrorStatus: 'Delete Error Accounts',
      ...
      deleteErrorStatus: {
        title: 'Delete All Error Accounts',
        message:
          'This will delete every account whose status is error, regardless of the current page or filters. This action cannot be undone. Continue?',
        confirm: 'Delete Error Accounts',
        countLoading: 'Counting current error-status accounts...',
        countInfo: 'There are currently {count} error-status account(s).',
        countUnavailable: 'Unable to load the current error-status account count.',
        success: 'Deleted {count} error account(s)',
        partialSuccess: 'Partially deleted: {success} succeeded, {failed} failed',
        failed: 'Failed to delete error accounts'
      },
