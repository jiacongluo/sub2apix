<template>
  <div class="mb-4 flex items-center justify-between gap-3 rounded-lg bg-primary-50 p-3 dark:bg-primary-900/20">
...
defineEmits<{
  ...
  (e: 'clear'): void
  (e: 'select-page'): void
  (e: 'toggle-schedulable', schedulable: boolean): void
  (e: 'reset-status'): void
